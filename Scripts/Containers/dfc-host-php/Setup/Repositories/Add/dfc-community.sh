...
docker-compose -p $dfc_global__project_name exec -u root dfc-host-php zsh -c "echo 'https://dl-cdn.alpinelinux.org/alpine/v3.16/community' >> /etc/apk/repositories" >&1
